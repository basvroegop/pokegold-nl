...
; Boarder
	...
	const EVENT_BEAT_BOARDER_CALVIN
; Sage
...
; Juggler
	...
	const EVENT_BEAT_JUGGLER_RANDOLF
; Gentleman
...
; PokefanM
	...
	const EVENT_BEAT_POKEFANM_BAS1
; PokefanF
...
; Sailor
	...
	const EVENT_BEAT_SAILOR_WILLEM
; Super Nerd
