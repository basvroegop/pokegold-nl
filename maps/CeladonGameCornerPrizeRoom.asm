...
.MenuData:
	...
	db 4 ; items
	db "TM32    {d:CELADONGAMECORNERPRIZEROOM_TM32_COINS}@" ; "TM32    {d:CELADONGAMECORNERPRIZEROOM_TM32_COINS}@"
	db "TM29    {d:CELADONGAMECORNERPRIZEROOM_TM29_COINS}@" ; "TM29    {d:CELADONGAMECORNERPRIZEROOM_TM29_COINS}@"
	db "TM15    {d:CELADONGAMECORNERPRIZEROOM_TM15_COINS}@" ; "TM15    {d:CELADONGAMECORNERPRIZEROOM_TM15_COINS}@"
	db "SLUITEN@" ; "CANCEL@"
...
.MenuData:
	db STATICMENU_CURSOR ; flags
	db 4 ; items
	db "MR.MIME    {d:CELADONGAMECORNERPRIZEROOM_MR_MIME_COINS}@" ; "MR.MIME    {d:CELADONGAMECORNERPRIZEROOM_MR_MIME_COINS}@"
	db "EEVEE      {d:CELADONGAMECORNERPRIZEROOM_EEVEE_COINS}@" ; "EEVEE      {d:CELADONGAMECORNERPRIZEROOM_EEVEE_COINS}@"
	db "PORYGON    {d:CELADONGAMECORNERPRIZEROOM_PORYGON_COINS}@" ; "PORYGON    {d:CELADONGAMECORNERPRIZEROOM_PORYGON_COINS}@"
	db "CANCEL@" ; "CANCEL@"
